    ...
    <section id="certificates">
      ...
      <div className="grid grid-cols-[repeat(auto-fit,minmax(280px,1fr))] gap-6">
        {certificatesData.map((cert, index) => (
          <a
            ref={skillAnimations[index].ref}
            style={skillAnimations[index].style}
            href={cert.link}
            target="_blank"
            key={index}
            rel="noopener noreferrer"
            className="group relative block  bg-gradient-to-br from-slate-800 via-slate-900 to-slate-800 rounded-2xl border border-slate-700 overflow-hidden transition-all duration-500 hover:border-blue-500 hover:shadow-[0_0_40px_rgba(59,130,246,0.5)] hover:-translate-y-2"
          >
